...
# ..except for the ones specified in the omit argument.
# Inputs:
# use_scaling_from -- a data.frame of class "scale_df", 
# ..which contains former means and standard deviations of a dataset.
